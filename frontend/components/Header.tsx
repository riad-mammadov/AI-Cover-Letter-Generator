...
export default function Header() {
  return (
    <>
      <header className="relative w-full max-w-6xl mx-auto flex items-center flex-col sm:flex-row space-y-4 justify-center sm:justify-between py-6 px-4 sm:px-6 z-10">
        <Link href="/">
